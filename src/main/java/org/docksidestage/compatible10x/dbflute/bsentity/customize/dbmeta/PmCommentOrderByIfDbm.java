...
public class PmCommentOrderByIfDbm extends AbstractDBMeta {
    ...
    protected final String _tableDispName = "PmCommentOrderByIf";
    ...
    protected final ColumnInfo _columnMemberAccount = cci("MEMBER_ACCOUNT", "MEMBER_ACCOUNT", null, "会員アカウント", String.class, "memberAccount", null, false, false, false, "VARCHAR", 50, 0, null, null, false, null, "ログインIDとして利用する。\n昨今メールアドレスをログインIDとすることが多いので、あまり見かけないかも!?", null, null, null, false);
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.compatible10x.dbflute.exentity.customize.PmCommentOrderByIf"; }
    ...
    { doAcceptPrimaryKeyMap((PmCommentOrderByIf)et, mp); }
    public void acceptAllColumnMap(Entity et, Map<String, ? extends Object> mp)
    { doAcceptAllColumnMap((PmCommentOrderByIf)et, mp); }
