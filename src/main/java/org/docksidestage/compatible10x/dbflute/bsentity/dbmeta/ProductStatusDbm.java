...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    protected final ColumnInfo _columnDisplayOrder = cci("DISPLAY_ORDER", "DISPLAY_ORDER", null, "表示順", Integer.class, "displayOrder", null, false, false, true, "INTEGER", 10, 0, null, null, false, null, "もう、ご想像の通りです。", null, null, null, false);
