 ...
 */
public abstract class BsPmCommentEmbedded extends AbstractEntity {
    ...
    public DBMeta getDBMeta() {
        return org.docksidestage.compatible10x.dbflute.bsentity.customize.dbmeta.PmCommentEmbeddedDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsPmCommentEmbedded) {
