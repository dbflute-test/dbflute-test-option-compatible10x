...
public abstract class BsOptionMember extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return org.docksidestage.compatible10x.dbflute.bsentity.customize.dbmeta.OptionMemberDbm.getInstance();
    }
    ...
    public void setDummyFlgAsBoolean(Boolean determination) {
        setDummyFlgAsFlg(CDef.Flg.of(determination).orElse(null));
    }
