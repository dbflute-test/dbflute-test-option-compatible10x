...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    protected void xsetupEpg() {
        ...
        setupEpg(_epgMap, et -> ((MemberFollowing)et).getFollowDatetime(), (et, vl) -> ((MemberFollowing)et).setFollowDatetime(cttp(vl)), "followDatetime");
    }
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnMemberFollowingId = cci("MEMBER_FOLLOWING_ID", "MEMBER_FOLLOWING_ID", null, "会員フォローイングID", Long.class, "memberFollowingId", null, true, true, true, "BIGINT", 19, 0, null, "NEXT VALUE FOR PUBLIC.SYSTEM_SEQUENCE_8ED4AC6F_8D4F_4A3D_9EF7_37C9351BA237", false, null, "連番", null, null, null, false);
    ...
    protected final ColumnInfo _columnFollowDatetime = cci("FOLLOW_DATETIME", "FOLLOW_DATETIME", null, "その瞬間", java.sql.Timestamp.class, "followDatetime", null, false, false, true, "TIMESTAMP", 23, 10, null, null, false, null, "ふりかえるとちょっと恥ずかしい気持ちになる日時", null, null, null, false);
    ...
    public ForeignInfo foreignMemberByMyMemberId() {
        ...
        return cfi("FK_MEMBER_FOLLOWING_MY_MEMBER", "memberByMyMemberId", this, MemberDbm.getInstance(), mp, 0, null, false, false, false, false, null, null, false, "memberFollowingByMyMemberIdList", false);
    }
    /**
    ...
    public ForeignInfo foreignMemberByYourMemberId() {
        ...
        return cfi("FK_MEMBER_FOLLOWING_YOUR_MEMBER", "memberByYourMemberId", this, MemberDbm.getInstance(), mp, 1, null, false, false, false, false, null, null, false, "memberFollowingByYourMemberIdList", false);
    }
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "org.docksidestage.compatible10x.dbflute.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "org.docksidestage.compatible10x.dbflute.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "org.docksidestage.compatible10x.dbflute.exbhv.MemberFollowingBhv"; }
