...
public abstract class BsVendorPrimaryKeyOnlyBhv extends AbstractBehaviorWritable<VendorPrimaryKeyOnly, VendorPrimaryKeyOnlyCB> {
     ...
     * int count = <span style="color: #0000C0">vendorPrimaryKeyOnlyBhv</span>.<span style="color: #CC4747">selectCount</span>(cb);
     * </pre>
     ...
     * if (vendorPrimaryKeyOnly != null) { <span style="color: #3F7E5E">// null check</span>
     ...
     * for (VendorPrimaryKeyOnly vendorPrimaryKeyOnly : <span style="color: #553000">vendorPrimaryKeyOnlyList</span>) {
     *     ... = vendorPrimaryKeyOnly.get...();
     * }
     * </pre>
     * @param cb The condition-bean of VendorPrimaryKeyOnly. (NotNull)
     ...
     * VendorPrimaryKeyOnlyCB cb = new VendorPrimaryKeyOnlyCB();
     * cb.query().set...
     * <span style="color: #0000C0">vendorPrimaryKeyOnlyBhv</span>.<span style="color: #CC4747">selectCursor</span>(cb, new EntityRowHandler&lt;VendorPrimaryKeyOnly&gt;() {
     ...
     * <span style="color: #0000C0">vendorPrimaryKeyOnlyBhv</span>.<span style="color: #CC4747">batchUpdate</span>(vendorPrimaryKeyOnlyList, new SpecifyQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     ...
     * <span style="color: #0000C0">vendorPrimaryKeyOnlyBhv</span>.<span style="color: #CC4747">varyingInsert</span>(vendorPrimaryKeyOnly, option);
     * ... = vendorPrimaryKeyOnly.getPK...(); <span style="color: #3F7E5E">// if auto-increment, you can get the value after</span>
     * </pre>
     * @param vendorPrimaryKeyOnly The entity of insert. (NotNull, PrimaryKeyNullAllowed: when auto-increment)
     ...
     * <span style="color: #0000C0">vendorPrimaryKeyOnlyBhv</span>.<span style="color: #CC4747">varyingQueryUpdate</span>(vendorPrimaryKeyOnly, cb, option);
     * </pre>
