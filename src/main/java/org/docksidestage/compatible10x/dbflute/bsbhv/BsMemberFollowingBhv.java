...
public abstract class BsMemberFollowingBhv extends AbstractBehaviorWritable<MemberFollowing, MemberFollowingCB> {
     ...
     */
    public int varyingQueryUpdate(MemberFollowing memberFollowing, MemberFollowingCB cb, WOptionCall<MemberFollowingCB, UpdateOption<MemberFollowingCB>> opLambda) {
        return doQueryUpdate(memberFollowing, cb, handleUpdateOpCall(opLambda));
    }
     ...
     */
    public int varyingQueryDelete(MemberFollowingCB cb, WOptionCall<MemberFollowingCB, DeleteOption<MemberFollowingCB>> opLambda) {
