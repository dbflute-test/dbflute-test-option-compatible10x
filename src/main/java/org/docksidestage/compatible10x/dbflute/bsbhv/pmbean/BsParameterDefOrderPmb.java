 ...
 */
public class BsParameterDefOrderPmb implements ExecuteHandlingPmb<MemberBhv>, FetchBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    /** The parameter of overProp. */
    protected Integer _overProp;

    /** The parameter of underProp. */
    protected Integer _underProp;
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "whitebox:pmbean:selectParameterDefOrder"; }
    ...
    protected String xbuildColumnString() {
        final String dm = ", ";
        final StringBuilder sb = new StringBuilder();
        sb.append(dm).append(_overProp);
        sb.append(dm).append(_underProp);
