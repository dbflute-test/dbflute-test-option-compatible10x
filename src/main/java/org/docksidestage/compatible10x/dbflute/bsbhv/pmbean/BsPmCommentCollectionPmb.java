...
public class BsPmCommentCollectionPmb implements ListHandlingPmb<MemberBhv, PmCommentCollection>, EntityHandlingPmb<MemberBhv, PmCommentCollection>, FetchBean {
    ...
    protected Collection<org.docksidestage.compatible10x.dbflute.allcommon.CDef.MemberStatus> _statusList;
     ...
     * {@inheritDoc}
     */
    public String getOutsideSqlPath() { return "whitebox:pmcomment:selectPmCommentCollection"; }
