 ...
 */
package org.docksidestage.compatible10x.dbflute.cbean.bs;
...
import org.docksidestage.compatible10x.dbflute.allcommon.ImplementedInvokerAssistant;
...
public class BsVendorPrimaryKeyOnlyCB extends AbstractConditionBean {
     ...
     * <pre>
     * cb.query().<span style="color: #CC4747">union</span>(new UnionQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     ...
     * because it inherits calls before. (Don't call SetupSelect after here)
     * <pre>
     * cb.query().<span style="color: #CC4747">unionAll</span>(new UnionQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     *     public void query(VendorPrimaryKeyOnlyCB unionCB) {
     *         unionCB.query().setXxx...
     *     }
     * });
     ...
     * cb.<span style="color: #CC4747">columnQuery</span>(new SpecifyQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
    ...
    public HpColQyOperand<VendorPrimaryKeyOnlyCB> columnQuery(final SpecifyQuery<VendorPrimaryKeyOnlyCB> colCBLambda) {
        return xcreateColQyOperand(new HpColQyHandler<VendorPrimaryKeyOnlyCB>() {
            public ColumnCalculator handle(SpecifyQuery<VendorPrimaryKeyOnlyCB> rightSp, String operand) {
     ...
     * cb.<span style="color: #CC4747">orScopeQuery</span>(new OrQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
     ...
     *     public void query(VendorPrimaryKeyOnlyCB orCB) {
     *         orCB.query().setFOO_Equal...
     *         orCB.<span style="color: #CC4747">orScopeQueryAndPart</span>(new AndQuery&lt;VendorPrimaryKeyOnlyCB&gt;() {
