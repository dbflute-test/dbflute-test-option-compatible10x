...
public class DBFluteConfig {
    ...
    protected boolean _orScopeQueryPurposeCheckWarningOnly = true; // since 1.2.7
    protected boolean _thatsBadTimingDetect = true;
    protected boolean _thatsBadTimingWarningOnly = true;
    ...
    protected boolean _invalidQueryAllowedWarning = true; // since 1.2.7
    protected boolean _nonSpecifiedColumnAccessAllowed = false;
    protected boolean _nonSpecifiedColumnAccessWarningOnly = true; // since 1.2.7
